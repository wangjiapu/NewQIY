...
public class VideoHistory extends AppCompatActivity implements View.OnClickListener{
    ...
    private void initWight() {
        ...
        if(isLoginIn == 0){
            ...
            progressDialog.show();
            historyVideoDatas = DataBaseModify.getVideoHistoryList(VideoHistory.this);
            progressDialog.dismiss();

            if(historyVideoDatas.size() == 0){
                ...
                videoHistoryAdapter = new VideoHistoryAdapter(this,historyVideoDatas);
