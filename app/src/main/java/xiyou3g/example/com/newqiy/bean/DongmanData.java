...
/**
 * Created by Kiboooo on 2017/6/16.
 */

public class DongmanData {
    private String ID;
    private String TitleBar;
    private VideoData[] videoData = new VideoData[10];
    private boolean[] isVIP = new boolean[10];
    ...
    public void setVIP(boolean VIP,int x) {
        isVIP[x] = VIP;
    }
